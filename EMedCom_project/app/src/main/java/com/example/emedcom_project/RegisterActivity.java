...
public class RegisterActivity extends AppCompatActivity {
    ...
    private RadioButton charity, centre, user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        charity = (RadioButton) findViewById(R.id.id_charity);
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if(task.isSuccessful()) {
                                            ...
                                            if(user_type.equals("Normal User")) {
                                                //user info updated successfully
                                                showMessage("Registration Complete");
                                                showMessage("You are on the home page now");
                                                updateUI();
                                            }
                                            else if(user_type.equals("Collection Centre")) {
                                                Toast.makeText(RegisterActivity.this,"hello Collection Centre ",
                                                        Toast.LENGTH_LONG).show();
                                                updatecollection();
                                            }
                                            else if(user_type.equals("Charity")) {

                                                Toast.makeText(RegisterActivity.this,"hello Charity Organisation ",
                                                        Toast.LENGTH_LONG).show();
                                                updatecharity();
                                            }
                                        }
    ...
    private void updatecollection() {
        ...
        Intent loginActivity = new Intent(getApplicationContext(), CollectionHome.class);
        startActivity(loginActivity);
        finish();
    ...
    private void updatecharity() {
        ...
        Intent loginActivity = new Intent(getApplicationContext(), CharityHome.class);
        startActivity(loginActivity);
        finish();
